...
export const heroSectionData = {
    ...
    hero_features: [
        ...
        { icon: LeafIcon, title: "100% Fresh", desc: "Organic products" },
...
export const footerData = {
    brand: {
        name: "Aniakor",
        description: "We sell fresh farm produce straight from local farms to your doorstep. Kindly visit us today",
        socials: [
    ...
    contact: [
        { icon: MapPinIcon, text: "214 High Street, Brierley Hill, Dudley, United Kingdom" },
        { icon: PhoneIcon, text: "+447526000296" },
        { icon: MailIcon, text: "carlosaniakorchukwu@gmail.com" },
    ],

    bottom: {
        copyright: "© 2026 Aniakor. All rights reserved.",
        links: [
...
export const dummyDashboardOrdersData = [
    {
        shippingAddress: {
            label: "Home",
            address: "214 High Street, Pensnet Road",
            city: "Brierley Hill ",
            state: "Dudley",
            zip: "876543",
            lat: 40.7128,
    ...
    {
        shippingAddress: { label: "Home", address: "214 High Street Pensnet Road ", city: "Brierley Hill ", state: "Dudley", zip: "876543", lat: 40.7128, lng: -74.006 },
        ...
        deliveryPartner: { _id: "69bbfc3866db7c6cdea47ede", name: "Reuben", email: "reuben@example.com", phone: "07526000296" },
        deliveryOtp: "754730",
        isPaid: false,
        createdAt: "2026-04-06T07:53:05.774Z",
        updatedAt: "2026-04-06T08:47:28.984Z",
...
export const dummyAddressData = [
    { label: "Home", address: "214 High Street ", city: "Brierley Hill ", state: "Dudley", zip: "10001", isDefault: true, lat: 40.7128, lng: -74.006, _id: "69d3652df9a340288f1a0f8c" },
    { label: "Work", address: "214 High Street", city: "Brierley Hill", state: "Dudley", zip: "10001", isDefault: false, lat: 40.7128, lng: -74.006, _id: "69d3652df9a340288f1a0f8d" },
];

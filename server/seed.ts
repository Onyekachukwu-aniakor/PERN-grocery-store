...
const seedDB = async () => {
    try {
        //delete existing data in the database before storing new one
        await prisma.product.deleteMany({});
        console.log('Cleared existing products')

        //add the product list in an array
        const products : Prisma.ProductCreateManyInput[] = [
    {
       
        name: "Butter Croissant 10g",
